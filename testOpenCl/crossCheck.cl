...
__kernel void crossCheck(__write_only image2d_t output, __read_only image2d_t leftDisp, __read_only image2d_t rightDisp) {
	...
	if (abs_diff(leftVal, rightVal) > CROSS_TH) {
